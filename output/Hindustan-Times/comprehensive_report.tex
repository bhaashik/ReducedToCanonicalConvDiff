...
This report presents a comprehensive analysis of linguistic differences between reduced register (newspaper headlines) and canonical forms. The analysis identified \textbf{48,472} difference events across \textbf{30} distinct linguistic features.

\subsection{Key Findings}
\begin{itemize}
\item \textbf{Constituent Movement} (CONST-MOV): 13,099 occurrences (27.0\% of total)
\item \textbf{Dependency Relation Change} (DEP-REL-CHG): 11,759 occurrences (24.3\% of total)
\item \textbf{Clause Type Change} (CLAUSE-TYPE-CHG): 3,408 occurrences (7.0\% of total)
\item \textbf{Function Word Deletion} (FW-DEL): 3,210 occurrences (6.6\% of total)
\item \textbf{Content Word Deletion} (C-DEL): 1,405 occurrences (2.9\% of total)
\end{itemize}
...
PUNCT-DEL & Punctuation Deletion & Other & 420 \\
