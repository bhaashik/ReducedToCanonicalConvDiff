...
This report presents a comprehensive analysis of linguistic differences between reduced register (newspaper headlines) and canonical forms. The analysis identified \textbf{39,998} difference events across \textbf{21} distinct linguistic features.

\subsection{Key Findings}
\begin{itemize}
\item \textbf{Constituent Movement} (CONST-MOV): 13,099 occurrences (32.7\% of total)
\item \textbf{Dependency Relation Change} (DEP-REL-CHG): 11,759 occurrences (29.4\% of total)
\item \textbf{Clause Type Change} (CLAUSE-TYPE-CHG): 3,408 occurrences (8.5\% of total)
\item \textbf{Function Word Deletion} (FW-DEL): 3,210 occurrences (8.0\% of total)
\item \textbf{Content Word Deletion} (C-DEL): 1,405 occurrences (3.5\% of total)
\end{itemize}
