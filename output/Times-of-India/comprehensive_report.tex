...
This report presents a comprehensive analysis of linguistic differences between reduced register (newspaper headlines) and canonical forms. The analysis identified \textbf{41,616} difference events across \textbf{30} distinct linguistic features.

\subsection{Key Findings}
\begin{itemize}
\item \textbf{Constituent Movement} (CONST-MOV): 11,485 occurrences (27.6\% of total)
\item \textbf{Dependency Relation Change} (DEP-REL-CHG): 9,892 occurrences (23.8\% of total)
\item \textbf{Clause Type Change} (CLAUSE-TYPE-CHG): 2,728 occurrences (6.6\% of total)
\item \textbf{Function Word Deletion} (FW-DEL): 2,241 occurrences (5.4\% of total)
\item \textbf{Punctuation Deletion} (PUNCT-DEL): 1,306 occurrences (3.1\% of total)
\end{itemize}
...
PUNCT-DEL & Punctuation Deletion & Other & 1,306 \\
