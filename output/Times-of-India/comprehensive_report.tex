...
This report presents a comprehensive analysis of linguistic differences between reduced register (newspaper headlines) and canonical forms. The analysis identified \textbf{30,847} difference events across \textbf{18} distinct linguistic features.

\subsection{Key Findings}
\begin{itemize}
\item \textbf{Constituent Movement} (CONST-MOV): 11,485 occurrences (37.2\% of total)
\item \textbf{Dependency Relation Change} (DEP-REL-CHG): 9,892 occurrences (32.1\% of total)
\item \textbf{Clause Type Change} (CLAUSE-TYPE-CHG): 2,728 occurrences (8.8\% of total)
\item \textbf{Function Word Deletion} (FW-DEL): 2,241 occurrences (7.3\% of total)
\item \textbf{Tree Edit Distance} (TED): 1,034 occurrences (3.4\% of total)
\end{itemize}
...
TED & Tree Edit Distance & Structural & 1,034 \\
