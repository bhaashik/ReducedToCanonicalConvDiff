...
This report presents a comprehensive analysis of linguistic differences between reduced register (newspaper headlines) and canonical forms. The analysis identified \textbf{33,525} difference events across \textbf{21} distinct linguistic features.

\subsection{Key Findings}
\begin{itemize}
\item \textbf{Constituent Movement} (CONST-MOV): 11,485 occurrences (34.3\% of total)
\item \textbf{Dependency Relation Change} (DEP-REL-CHG): 9,892 occurrences (29.5\% of total)
\item \textbf{Clause Type Change} (CLAUSE-TYPE-CHG): 2,728 occurrences (8.1\% of total)
\item \textbf{Function Word Deletion} (FW-DEL): 2,241 occurrences (6.7\% of total)
\item \textbf{TED-RTED} (TED-RTED): 1,035 occurrences (3.1\% of total)
\end{itemize}
