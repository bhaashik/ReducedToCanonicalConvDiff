...
This report presents a comprehensive analysis of linguistic differences between reduced register (newspaper headlines) and canonical forms. The analysis identified \textbf{31,859} difference events across \textbf{30} distinct linguistic features.

\subsection{Key Findings}
\begin{itemize}
\item \textbf{Constituent Movement} (CONST-MOV): 5,705 occurrences (17.9\% of total)
\item \textbf{Dependency Relation Change} (DEP-REL-CHG): 5,284 occurrences (16.6\% of total)
\item \textbf{Function Word Deletion} (FW-DEL): 1,661 occurrences (5.2\% of total)
\item \textbf{Clause Type Change} (CLAUSE-TYPE-CHG): 1,500 occurrences (4.7\% of total)
\item \textbf{Headline Structure} (H-STRUCT): 1,500 occurrences (4.7\% of total)
\end{itemize}
...
H-STRUCT & Headline Structure & Other & 1,500 \\
H-TYPE & Headline Type & Other & 1,500 \\
TREE-DEPTH-DIFF & Tree Depth Difference & Other & 1,500 \\
CONST-COUNT-DIFF & Constituent Count Difference & Other & 1,500 \\
DEP-DIST-DIFF & Dependency Distance Difference & Other & 1,500 \\
BRANCH-DIFF & Branching Factor Difference & Other & 1,500 \\
PUNCT-DEL & Punctuation Deletion & Other & 1,221 \\
...
PUNCT-ADD & Punctuation Addition & Other & 190 \\
...
PUNCT-SUBST & Punctuation Substitution & Other & 67 \\
...
TREE-DEPTH-DIFF & 1,500 \\
CONST-COUNT-DIFF & 1,500 \\
BRANCH-DIFF & 1,500 \\
TED-RTED & 1,139 \\
