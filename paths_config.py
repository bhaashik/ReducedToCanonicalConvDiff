...
TEXT_FILES = {
    "Hindustan-Times": {
        "canonical": BASE_DIR / "data/input/input-single-line-break/Hindustan-Times-canonical.txt",
        "headlines": BASE_DIR / "data/input/input-single-line-break/Hindustan-Times-headlines.txt"
    },
    "The-Hindu": {
        "canonical": BASE_DIR / "data/input/input-single-line-break/The-Hindu-corrected-canonical.txt",
        "headlines": BASE_DIR / "data/input/input-single-line-break/The-Hindu-corrected-headlines.txt"
    },
    "Times-of-India": {
        "canonical": BASE_DIR / "data/input/input-single-line-break/Times-of-India-corrected-canonical.txt",
        "headlines": BASE_DIR / "data/input/input-single-line-break/Times-of-India-corrected-headlines.txt"
    }
}
